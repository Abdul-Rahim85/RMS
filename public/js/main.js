...
function scrollRow(rowId, distance) {
  ...
  console.log('wehn page loaded: ' + row.scrollLeft);
  
  row.scrollBy({ left: distance, behavior: 'smooth' });
}

// const abc = document.getElementById("meals");
// console.log('the whol content width: ' + abc.scrollWidth);
// console.log('the windows that shows the content: ' + abc.clientWidth);
// console.log('the scroll amount from left: ' + abc.scrollLeft);